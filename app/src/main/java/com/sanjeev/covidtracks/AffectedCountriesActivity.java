...
import com.sanjeev.covidtracks.Adaptor.MyCustomAdaptor;
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    adaptor = new MyCustomAdaptor(AffectedCountriesActivity.this,countryModelList);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(AffectedCountriesActivity.this, "Error : " + error.getMessage(), Toast.LENGTH_LONG).show();
                simpleArcLoader.stop();
                simpleArcLoader.setVisibility(View.GONE);
